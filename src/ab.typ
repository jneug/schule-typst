...
#let arbeitsblatt(
  ...
  set par(
    leading: 1.2em,
    ..get.args(args, prefix: "par")(justify: true),
  )
  set text(
    font: from-args(font: theme.fonts.default).font,
  ...
  // Fix for german decimal separator in math mode
  show: decimal-fix
