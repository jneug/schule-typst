...
#v(1em)
#rahmen[
	#place(top+right, image("images/Q2-AB.3-Abb_RMS Titanic.jpg", width:4.5cm))
...
#aufgabe[
	...
	#infobox[
		Die _Entropie_ berechnet sich durch $E_"gesamt" = -P_"ja"\cdot log_2(P_"ja") -P_"nein"\cdot log_2(P_"nein")$, wobei $P_"ja/nein"$ den Anteil der Datensätze mit der Ausprägung "überlebt = ja" bzw. "überlebt = nein" darstellt.
	]
]
...
#aufgabe[
	...
	#infobox[
		Der _Informationsgewinn_ $"IG"_"Attribut"$ eines Attributs berechnet sich durch $E_"gesamt" - sum P_"Attributwert"\cdot E_"Attributwert"$.
	]
]
